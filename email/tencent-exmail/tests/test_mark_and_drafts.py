...
class MarkAndDraftTests(unittest.TestCase):
    ...
    def test_mark_uses_explicit_uid_and_seen_flag(self):
        ...
        with patch.object(reader.imaplib, "IMAP4_SSL", return_value=Client()):
            result = reader.update_read_state({"imap": {"host": "host", "port": 993}, "account": {"email": "sender@example.com", "password": "secret"}}, "INBOX", ["9"], True)
